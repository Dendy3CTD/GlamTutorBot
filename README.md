...
| **v0.8.0** | `d990287` | Меню: Начать, Настройки аккаунта, Прошлые заказы, Обратная связь. Настройки: город, карты, чеки, статистика, пол, псевдоним, комментарии. Админ-панель: добавление товаров, ответы на обратную связь. |
